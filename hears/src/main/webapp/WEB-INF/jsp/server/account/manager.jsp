...
<head>
    ...
    <title>worldHears</title>

    <!-- Bootstrap Core CSS -->
    <link href="../../../../css/bootstrap/bootstrap.min.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="../../../../css/bootstrap/metisMenu.css" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">worldHears</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.jsp"><i class="fa fa-dashboard fa-fw"></i>基本信息</a>
                        </li>
                        <li>
    ...
    <script src="../../../../js/bootstrap/morris-data.js"></script>
